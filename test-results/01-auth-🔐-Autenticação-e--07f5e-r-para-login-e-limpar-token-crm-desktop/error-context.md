...
- Name: 01-auth.spec.ts >> 🔐 Autenticação e Controle de Acesso >> RF-05: Logout deve redirecionar para /login e limpar token
- Location: tests\e2e\01-auth.spec.ts:23:3
